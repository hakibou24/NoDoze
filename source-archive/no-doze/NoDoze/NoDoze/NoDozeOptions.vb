...
#End Region
    ...
    Private Function ExtractAppName(windowTitle As String) As String
        Dim appName As String = windowTitle
        Dim lastDash As Integer = windowTitle.LastIndexOf(" - ")
        If lastDash >= 0 Then
            appName = windowTitle.Substring(lastDash + 3).Trim()
        End If
        If appName.Length > 64 Then
    ...
    Private Sub ProcessesTimer_Tick(sender As Object, e As EventArgs) Handles ProcessesTimer.Tick
        ...
        For Each p As System.Diagnostics.Process In Process.GetProcesses
            newProcesses.Add(ExtractAppName(p.MainWindowTitle))
        Next
